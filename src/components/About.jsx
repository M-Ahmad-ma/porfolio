        ...
        <ScrollReveal delay={0.1}>
          <div className="space-y-4 text-tokyo-muted">
            <p className="text-lg leading-relaxed">
              <span className="text-tokyo-green">const</span> about ={" "}
              <span className="text-tokyo-string">
                "I'm a Full Stack Developer passionate about building scalable and high-performance applications."
              </span>;
            </p>

            <p className="leading-relaxed">
              With 2 years of hands-on experience, I build end-to-end applications,
              working across frontend interfaces, backend systems, and APIs. I
              specialize in Node.js with TypeScript and PHP (Laravel, CodeIgniter),
              focusing on clean architecture and maintainable code.
            </p>

            <p className="leading-relaxed">
              My work includes RESTful API development, JWT authentication, role-based
              access control, multi-tenant systems, and performance-focused database
              design. I’ve worked with PostgreSQL, MySQL, and Redis for efficient data
              handling and caching.
            </p>

            <p className="leading-relaxed">
              I’m also comfortable with Docker and Docker Compose for containerized
              deployments and consistent development environments.
            </p>

            <p className="leading-relaxed">
              Currently open to Full Stack Developer opportunities where I can build
              impactful products and continue growing as an engineer.
            </p>
          </div>
        </ScrollReveal>
        <div className="mt-8">
