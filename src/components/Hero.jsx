...
const phrases = [
  'Building applications, not excuses.',
    ...
    <section id="hero" className="min-h-screen flex items-center justify-center pt-20 px-4 md:px-6 overflow-hidden">
      ...
      >
        ...
        <motion.p variants={itemVariants} className="text-tokyo-muted max-w-xl mx-auto mb-8 md:mb-10 text-sm md:text-lg">
          FullStack Developer with 2 years of experience building scalable APIs and robust server-side applications.
        </motion.p>
        ...
        <motion.div variants={itemVariants} className="flex flex-col md:flex-row justify-center gap-2 md:gap-6">
          ...
          >
            <Github size={18} />
            <span className="hidden md:inline">https://github.com/M-Ahmad-ma</span>
          </motion.a>
          <motion.a
          ...
          >
            <Mail size={18} />
            <span className="hidden md:inline">muhammadahmadma4642@gmail.com</span>
          </motion.a>
        </motion.div>
