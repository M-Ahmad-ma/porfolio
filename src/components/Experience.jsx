...
const experiences = [
  {
    ...
    company: 'BitCoderLabs',
    duration: '2 Years',
    description: 'Built and shipped full-stack applications across web and mobile using React, Next.js, React Native, Kotlin, and Node.js — delivering end-to-end features from database design to deployment.',
    highlights: [
      'Designed and consumed RESTful APIs for web and mobile clients',
      'Worked with relational databases (MySQL, PostgreSQL) including schema design and query optimization',
      'Built authentication and authorization systems with JWT and role-based access control',
      'Developed real-time applications with live data synchronization',
    ],
  }]
